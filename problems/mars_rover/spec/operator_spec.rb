...
describe MarsRover::Operator do
  
  describe "#receive" do
    before(:each) do
      @rover = double("rover")
      @operator = MarsRover::Operator.new(@rover)
    end
    ...
    # context "given input RR" do
    #   it "turns the rover right twice" do
    #     @rover.should_receive(:turn_right).twice
    #     @operator.receive "RR"
    #   end
    # end
